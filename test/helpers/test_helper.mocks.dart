...
import 'package:flutter_weather_app_with_tdd/data/data.dart' as _i3;
...
class MockWeatherRepository extends _i1.Mock implements _i5.WeatherRepository {
  ...
  @override
  _i6.Future<_i2.Either<_i3.Failure, _i7.Weather>> getCurrentWeather(
          String? cityName) =>
      (super.noSuchMethod(Invocation.method(#getCurrentWeather, [cityName]),
              returnValue: Future<_i2.Either<_i3.Failure, _i7.Weather>>.value(
                  _FakeEither_0<_i3.Failure, _i7.Weather>()))
          as _i6.Future<_i2.Either<_i3.Failure, _i7.Weather>>);
}
